...
import com.neko.modules.merchant.entity.NekoProductInfo;
import com.neko.modules.merchant.service.INekoProductInfoService;
...
@Api(tags="商品信息")
@RestController
@RequestMapping("/merchant/nekoProductInfo")
@Slf4j
public class NekoProductInfoController extends JeecgController<NekoProductInfo, INekoProductInfoService> {
	@Autowired
	private INekoProductInfoService nekoProductInfoService;
	...
	public Result<IPage<NekoProductInfo>> queryPageList(NekoProductInfo nekoProductInfo,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
								   HttpServletRequest req) {
        QueryWrapper<NekoProductInfo> queryWrapper = QueryGenerator.initQueryWrapper(nekoProductInfo, req.getParameterMap());
		Page<NekoProductInfo> page = new Page<NekoProductInfo>(pageNo, pageSize);
		IPage<NekoProductInfo> pageList = nekoProductInfoService.page(page, queryWrapper);
	...
	public Result<NekoProductInfo> queryById(@RequestParam(name="id",required=true) String id) {
		NekoProductInfo nekoProductInfo = nekoProductInfoService.getById(id);
		if(nekoProductInfo==null) {
			return Result.error("未找到对应数据");
		}
		return Result.OK(nekoProductInfo);
	}
