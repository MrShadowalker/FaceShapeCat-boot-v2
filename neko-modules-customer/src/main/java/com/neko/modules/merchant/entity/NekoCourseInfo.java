 ...
 */
@Data
@TableName("neko_course_info")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="neko_course_info对象", description="疗程信息")
public class NekoCourseInfo implements Serializable {
	...
	/**疗程描述*/
	@Excel(name = "疗程描述", width = 15)
    @ApiModelProperty(value = "疗程描述")
	...
	/**疗程价格，单位：分*/
	@Excel(name = "疗程价格，单位：分", width = 15)
    @ApiModelProperty(value = "疗程价格，单位：分")
